...
export function Environment(name: string): BaseURL {
    return `https://${name}-vrnkc.encr.app`
}
...
/**
 * Client is an API client for the vrnkc Encore application.
 */
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "vrnkc-Generated-TS-Client (Encore/v1.50.4)";
        }
