...
export function Environment(name: string): BaseURL {
    return `https://${name}-zhry8.encr.app`
}
...
/**
 * Client is an API client for the zhry8 Encore application.
 */
...
export namespace boards {
    ...
    export class ServiceClient {
         ...
         * Create New Board
         */
        public async create(params: CreateBoardRequest): Promise<CreateBoardResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/boards`, JSON.stringify(params))
            return await resp.json() as CreateBoardResponse
        }

        /**
         * Get All Boards
         */
        public async read(params: GetAllBoardsRequest): Promise<GetAllBoardsResponse> {
            ...
            return await resp.json() as GetAllBoardsResponse
        }
...
export namespace webhooks {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.clerk = this.clerk.bind(this)
        }

        public async clerk(method: "POST", body?: RequestInit["body"], options?: CallParameters): Promise<globalThis.Response> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "zhry8-Generated-TS-Client (Encore/v1.50.6)";
        }
