...
export function Environment(name: string): BaseURL {
  return `https://${name}-vs6sc.encr.app`;
}
...
/**
 * Client is an API client for the vs6sc Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    if (!BROWSER) {
      this.headers["User-Agent"] = "vs6sc-Generated-TS-Client (Encore/v1.50.4)";
    }
